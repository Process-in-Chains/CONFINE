...
df_simulation = pd.read_csv('./heuristicsMinerConfiguration/incrementalHeuristics.segsize100.motivating.csv', decimal='.', header=0)
...
df_sepsis = pd.read_csv('./heuristicsMinerConfiguration/incrementalHeuristics.segsize100.sepsis.csv', decimal='.', header=0,)
...
df_volvo = pd.read_csv('./heuristicsMinerConfiguration/incrementalHeuristics.segsize100.volvo.csv', decimal='.', header=0,)
...
plt.savefig('multilog_heuristicsMinerConfiguration.pdf')
plt.show()
exit()
