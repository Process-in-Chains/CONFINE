...
![SecureMinerInterface](https://github.com/user-attachments/assets/98866503-4aae-4a5b-a0d8-c3355a57149f)
...
- 6: Show the self-signed TLS certificate randomly generated by the Secure Miner at start-up. **Log servers should put the string result of this command inside the `minerList.json` file, according to the steps described previously. **
